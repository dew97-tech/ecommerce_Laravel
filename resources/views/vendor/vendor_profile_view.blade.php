{{-- Load all the essential Stylings --}}
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                {{-- if adminData has photo then folder upload/admin_images will load from there > if no
                                image found then load No image--}}
                        ...
                        <div class="card-body">
                            <form enctype="multipart/form-data" method="post"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <select name="vendor_join" class="form-select mb-3"
                                            aria-label="Default select example" value="{{ $vendorData->vendor_join }}">
                                            <option selected>Open this select menu</option>
                                            <option value="2021" {{ $vendorData->vendor_join == 2021 ? 'selected' :
                                                ''}} >2021</option>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <textarea class="form-control" id="vendor_short_info" name="vendor_short_info"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        {{-- Setting ID as Image for uploading image through JavaScript --}}
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        {{-- Setting ID as showImage for Target Set image through JavaScript --}}
                                        <img id="showImage"
